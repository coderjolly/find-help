            ...
            if (null != doctor) {
                ...
                for(Slot currSlot:slots) {
                    if(currSlot.getSlotTime().equals(slotTime)) {
                        ...
                        currSlot.setMeetingLink(doctor.getGoogleMeetLink());
                    }
                ...
                if(patientAppointments.containsKey(date)) {
                    ...
                    Slot patientSlot = new Slot(slotTime,doctor.getName(),"ASSIGNED",doctorEmail,null,"DOCTOR",doctor.getGoogleMeetLink());
                ...
                userRepository.save(patient);
                emailService.sendSimpleMail(patientEmail,"Appointment Scheduled","You appointment is scheduled for date: "+date + " at slot time "+ slotTime +" by doctor "+ doctor.getName() + " Your meeting link is as follows: "+doctor.getGoogleMeetLink()+". Regards, WeCare.");
