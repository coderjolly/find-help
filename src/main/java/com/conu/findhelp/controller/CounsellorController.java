...
public class CounsellorController {
    ...
    public ResponseEntity<?> getAllUsers(@RequestBody UpdatePatientRequest updatePatientRequest) throws Exception {
        try {
            FindHelpUser currentUser = userRepository.findUserByUsername(updatePatientRequest.getCounsellorEmail());
            if (null != currentUser) {
                ...
                if(updatePatientRequest.getStatus().equals("ASSIGN_DOCTOR")){
                    ...
                    currentUser.setDoctorAssigned(doctor.getEmail());
                    ...
                    currentUser.setCounsellingComment(currentUser.getCounsellingComment() != null  ?  currentUser.getCounsellingComment() + "," + updatePatientRequest.getReason() : updatePatientRequest.getReason()) ;
                    userRepository.save(currentUser);
